...
var defaultMenuOptions = []keys.KeyName{keys.KeyNew, keys.KeyPrompt, keys.KeyAttach, keys.KeyBoard, keys.KeySearch, keys.KeyMicroClaw, keys.KeyHelp, keys.KeyQuit}
